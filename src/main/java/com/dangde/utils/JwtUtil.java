...
public class JwtUtil {
   ...
   * @throws Exception
   */
  // public static String createJWT(String id, String issuer, String subject, long ttlMillis) throws
  // Exception {
  public static String createJWT(String id, String issuer, String subject) throws Exception {
